...
const linked = (C, { onClick, onKeyUp, prefix = '', tags = noTags, Link: L }) => {
...
const getHead = memoize(1)((Head, Link, prefix, events, tags) =>
...
const getLeaf = memoize(1)((Leaf, Link, prefix, events, tags) =>
